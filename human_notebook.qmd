...
Puisque la valeur de p est faible et inférieure au seuil alpha 5%. Nous rejetons H(0). Nous pouvons dire que l'indice de masse grasse (IMG) diffère de manière significative en fonction de la consommation de fast-food (test t billatéral, t = 3.4892, ddl = 52.776, valeur de p \<\<\< 0.05).
