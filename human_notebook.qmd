...
Nous observons dans le tableau de l\'ANOVA que la valeur p est faible et inférieure à 0.05. Nous rejetons H(0). Nous pouvons dire que l'IMG diffère significativement entre les niveaux d'activité physique (ANOVA, F = 140, ddl = 2 & 196, valeur p \<\< 0.0118).
