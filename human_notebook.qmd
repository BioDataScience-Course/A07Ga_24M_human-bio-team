...
chart (data = biometry_data, IMG ~ niveau_activite) +
  geom_boxplot() +
  labs(x = "Activité physique", y = "IMG", title = "Effet de l'activité physique sur l’IMG") 
```

<!--% Hypothèse nulle et alternative -->

-   H0: μ1 = μ2 = ...= μk. Il n'ya pas de différence significative entre les moyennes d'IMG selon le niveau d'activité physique.
