...
Lévaluation de l'influence du genre et du sommeil sur la masse corrigée a été realisée au travers d'un test ANOVA a 2 facteurs. Sur le plan statistique, en regard du terme genre (F = 23.05, ddl = 1 et 137, p = 0.000000408 \< 0,05 donc rejet de H0). En terme sommeil_rec (F = 4.17, ddl = 2 et 137, p = 0.0174 \< 0,05 donc rejet de H0). Et pour le terme genre:sommeil_rec ( ddl = 2 et 137, p = 0.727 \> 0.05 donc on ne rejette pas H0).
